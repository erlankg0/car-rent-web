# Generated by Django 3.2.7 on 2021-09-11 13:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='car',
            name='fuel_type',
            field=models.CharField(choices=[('PETROL', 'Бензин'), ('DIESEL', 'Дизель'), ('PETROL-GAZ', 'Бензин-Газ'), ('ELECTRIC', 'Электро')], max_length=100),
        ),
    ]
